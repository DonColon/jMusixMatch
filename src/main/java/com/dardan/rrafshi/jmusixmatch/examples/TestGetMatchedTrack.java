...
public final class TestGetMatchedTrack
{
	private static final Logger LOGGER = LoggerFactory.getLogger(TestGetMatchedTrack.class);
	...
	public static void main(final String[] args)
	{
		...
		try {
			...
			final Track track = musixMatch.getMatchingTrack("Something's Gotta Give Acoustic", "All Time Low");
